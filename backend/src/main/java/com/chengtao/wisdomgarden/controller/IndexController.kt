...
class IndexController {
    @RequestMapping("/")
    fun index(@CookieValue(value = WisdomGardenConfig.Cookies.USER_NAME, defaultValue = "") userName: String,
              @CookieValue(value = WisdomGardenConfig.Cookies.PASSWORD, defaultValue = "") password: String,
              model: Model): String {
