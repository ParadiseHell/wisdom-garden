 ...
 */
interface SightDao {
  fun createSight(category: Int, name: String, description: String, latitude: Float, longitude: Float): Sight?
  fun deleteSightById(id: Int): Boolean
  fun updateSight(id: Int, category: Int?, name: String? = null, description: String? = null, latitude: Float? = null, longitude: Float? = null): Sight?
